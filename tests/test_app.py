...
def test_signup_returns_400_for_already_registered_student():
    # Arrange
    activity_name = "Chess Club"
...
def test_unregister_from_existing_activity_succeeds():
    # Arrange
    activity_name = "Chess Club"
...
def test_unregister_returns_400_for_non_registered_student():
    # Arrange
    activity_name = "Chess Club"
